...
class IpNetblocksApiError(Exception):
...
class ParameterError(IpNetblocksApiError):
    pass


class EmptyApiKeyError(IpNetblocksApiError):
    pass


class ResponseError(IpNetblocksApiError):
    def __init__(self, message):
        self.message = message
...
class UnparsableApiResponseError(IpNetblocksApiError):
...
class HttpApiError(IpNetblocksApiError):
    pass
